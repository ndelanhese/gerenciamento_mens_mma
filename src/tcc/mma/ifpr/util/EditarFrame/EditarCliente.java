...
public class EditarCliente extends javax.swing.JInternalFrame {
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtDataCadastro, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(lblStatus)
                                        .addGap(18, 18, 18)
                                        .addComponent(jcbStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(35, 35, 35))
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void jbEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEditarActionPerformed
        ...
        if (resposta == 2) {
            ...
            if (a == 0) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos do formulário usando a tabela de Clientes", "Atenção", NORMAL);
                ...
                if (txtBairro.getText().isEmpty() || txtCPF.getText().isEmpty()
                    ...
                    try {
                        ...
                        Date dataCadastro = new Date(txtDataCadastro.getText());
                        int status = jcbStatus.getSelectedIndex() + 1;

                        Cliente cliente = new Cliente(id, nome, dataNascimento, cpf, rg, sexo, cidade, estado, endereco, numero, bairro, telefone, dataCadastro, status);
                        ClienteDAO daoCliente = new ClienteDAO(con);
