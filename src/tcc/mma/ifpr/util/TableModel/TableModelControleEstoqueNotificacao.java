...
public class TableModelControleEstoqueNotificacao extends AbstractTableModel{
    
    private List<Mercadoria> dados = new ArrayList<>();
    private String[] colunas = {"ID", "Categoria", "Mercadoria", "Quantidade"};
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        switch (coluna) {
            ...
            case 3:
                return dados.get(linha).getQuantide();
