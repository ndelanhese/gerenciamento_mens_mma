...
public class TableModelRelatorioVendas extends AbstractTableModel {

    private List<Venda> dados = new ArrayList<>();
    private final String[] colunas = {"ID", "Cliente", "Mercadorias", "Valor", "Data"};

    public TableModelRelatorioVendas() {
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        switch (coluna) {
            ...
            case 3:
                return dados.get(linha).getValorFinal();
            case 4:
    ...
    public void addRow(Venda mercadoria) {
