 ...
 * @author nnath
 */
public class RelatorioCondicionalStatus extends javax.swing.JInternalFrame {

    /**
     * Creates new form RelatorioCondicionalStatus
     */
    public RelatorioCondicionalStatus() {
        initComponents();
    }
    ...
    private void jbAtivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAtivoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Você realmente deseja atualizar o status da condicional para ATIVA?", "Atenção!",
            ...
            try {
                ...
                RelatorioCondicional condicional1 = (RelatorioCondicional) getParent().getComponent(1);
