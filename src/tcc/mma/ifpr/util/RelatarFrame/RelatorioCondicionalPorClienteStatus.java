 ...
 * @author nnath
 */
public class RelatorioCondicionalPorClienteStatus extends javax.swing.JInternalFrame {

    /**
     * Creates new form RelatorioCondicionalPorClienteStatus
     */
    public RelatorioCondicionalPorClienteStatus() {
        initComponents();
    }
    ...
    public void povoar(int pk) {
        ...
        try {
            ...
            Condicional condicional = daoCondicional.retrieve(pk);

            txtIDEncomenda.setText(String.valueOf(condicional.getId()));
            txtIDEncomenda.setVisible(false);
            jLabel1.setVisible(false);

            txtData.setText(String.valueOf(condicional.getDataRetirada()));
            ...
            transformarMerc(condicional.getMercadoria());
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Atualizar Status da Condicional");

        jLabel2.setText("Cliente:");

        jLabel1.setText("ID Condicional:");
    ...
    private void jbAtivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAtivoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Você realmente deseja atualizar o status da condicional para ATIVA?", "Atenção!",
            ...
            try {
                ...
                condicional.setStatus(1);
                condicional.setId(Integer.parseInt(txtIDEncomenda.getText()));

                daoCondicional.update(condicional);

                JOptionPane.showMessageDialog(null, "O status foi atualizado com sucesso");

                RelatorioCondicionalPorCliente condicional1 = (RelatorioCondicionalPorCliente) getParent().getComponent(1);

                condicional1.pegarTabela();
                condicional1.limpar();
    ...
    private void jbConcluidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbConcluidoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Você realmente deseja atualizar o status da condicional para CONCLUÍDA?", "Atenção!",
                JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void jbCanceladoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCanceladoActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Você realmente deseja atualizar o status da condicional para CANCELADA?", "Atenção!",
                JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
