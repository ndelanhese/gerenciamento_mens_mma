...
public class ExcluirUsuario extends javax.swing.JInternalFrame {
    ...
    public void pegarTabela() {
        ...
        try {
            ...
            List<Usuario> user = daoUsuario.retrieveAll();
    ...
    private void jtUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtUsuarioMouseClicked
        ...
        if (linhaSelecionada != -1) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Por motivos de segurança, digite a senha correspondente ao usuário '" + usuario1.getNome() + "' para dar continuidade na exclusão!");
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        if (txtConfirmarSenha.getText().isEmpty() || txtLogin.getText().isEmpty()
            ...
            if (JOptionPane.showConfirmDialog(null, "Você realmente deseja excluir o usuário '" + txtNome.getText() + "' ?", "Atenção!",
