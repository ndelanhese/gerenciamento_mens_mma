 ...
 * @author nnath
 */
public class ExcluirCategoria extends javax.swing.JInternalFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        if (txtCategoria.getText().isEmpty()) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Você realmente deseja excluir a categoria '" + txtCategoria.getText() + "' ?", "Atenção!",
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Categoria '" + txtCategoria.getText() + "' excluida com sucesso!");
                    pegarTabela();
